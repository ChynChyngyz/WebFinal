# Generated by Django 4.2.16 on 2024-12-04 04:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor_id', models.ManyToManyField(limit_choices_to={'role': 'Doctor'}, related_name='appointments', to=settings.AUTH_USER_MODEL, verbose_name='Доктор')),
